...
import 'package:flutter_timerman/src/common/widget/custom_checkbox.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                CustomCheckbox(
                  ...
                  value: true,
                  child: Text(
                      'Ознакомлен c политикой конфиденциальности и согласен на обработку персональных данных'),
                ),
                const Spacer(),
                OutlinedButton(
                  onPressed: () {},
